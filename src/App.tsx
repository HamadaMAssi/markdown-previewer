...
function App() {
  ...
  return (
    <>
      <div>
        <h1 style={{textAlign:"center", color: "#43D7FF"}}>Markdown Previewer</h1>
        <div className="boxes-container">
          <textarea name="editor" id="editor" className='box' value={markdownText} onChange={(e)=>setMarkdownText(e.target.value)}></textarea>
